;require.register("web/static/js/socket", function(exports, require, module) {
  ...
  socket.endPoint = 'wss://phoenixchatty.herokuapp.com/socket/websocket';
  // socket.endPoint = 'ws://localhost:4000/socket/websocket';
  socket.connect({ token: window.userToken });

  // Now that you are connected, you can join channels with a topic:
  var channel = socket.channel("rooms:"+encodeURIComponent(window.location.href), {});
